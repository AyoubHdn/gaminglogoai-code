export const TWITCH_BANNER_STYLES = [
    {
        id: "cyberpunkNeon",
        ...
        aiEnhancements: [
            {
                id: "cinematic",
                name: "Cinematic Glow",
                prompt: "Enhance this Twitch banner with cinematic neon lighting, high contrast, sharp typography, glowing accents, professional esports look, ultra clean composition",
            },
            {
                id: "cyberpunk",
                name: "Cyberpunk Style",
                prompt: "Transform this Twitch banner into a cyberpunk-inspired design, futuristic lighting, holographic effects, vibrant neon colors, professional streamer branding",
            },
        ],
        styleRules: {
            canvasWidth: 1200,
