        ...
        "Counter-Strike": [
            {
                ...
                basePrompt: "Design a tactical Counter-Strike-themed gaming logo for ''Text''. Use gritty, military-style fonts with weapon silhouettes and a bold, urban color palette."
            },
            {
                src: s3Style("/styles/s321.webp"),
                basePrompt: "Create a Counter-Strike logo for ''Text''. Incorporate sleek, modern lettering, camouflage or city rubble textures, and iconic CSGO gear for a high-stakes combat vibe."
            },
            {
                src: s3Style("/styles/s322.webp"),
                basePrompt: "Forge a dynamic Counter-Strike logo for ''Text''. Use edgy fonts, references to flashbangs or rifles, and a dark, intense backdrop to reflect competitive shooter energy."
            },
            {
                src: s3Style("/styles/s323.webp"),
                basePrompt: "Develop an action-ready Counter-Strike design for ''Text''. Combine bold, mission-focused text with sniper scope or bomb-defusal motifs, evoking intense strategic gameplay."
            },
            /*{
            ...
            },*/
            {
                ...
                basePrompt: "Create a professional Counter-Strike logo for ''Text''. Use strong, blocky lettering, subtle bullet hole effects, and team-based color schemes to capture squad-based warfare."
            },
            {
                src: s3Style("/styles/s326.webp"),
                basePrompt: "Design a high-impact Counter-Strike emblem for ''Text''. Combine bold, modern fonts with references to grenades or headshots, set against an electrifying tournament backdrop."
            },
            {
                src: s3Style("/styles/s327.webp"),
                basePrompt: "Generate a gritty Counter-Strike-themed logo for ''Text''. Use hard-edged typography, metallic textures, and iconic terrorist or counter-terrorist silhouettes for an immersive warzone feel."
            },
            {
                src: s3Style("/styles/s328.webp"),
                basePrompt: "Develop a creative Counter-Strike logo for ''Text''. Merge aggressive fonts with a blend of explosions, bullet casings, and urban map references, highlighting adrenaline-fueled gameplay."
            },
            {
                src: s3Style("/styles/s329.webp"),
                basePrompt: "Produce a modern Counter-Strike gaming logo for ''Text''. Incorporate strong typography, tactical gear icons, and dynamic lighting to evoke the tension and speed of the game."
            },
            {
                src: s3Style("/styles/s330.webp"),
                basePrompt: "Design an e-sports Counter-Strike mascot logo for ''Text''. Feature a masked operative or soldier in bold outlines and edgy fonts, capturing intense tactical energy."
            },
            {
                src: s3Style("/styles/s331.webp"),
                basePrompt: "Create a Counter-Strike e-sports emblem for ''Text''. Show a fierce commando or sniper with neon highlights, bold typography, and a gritty urban palette."
            },
            {
                src: s3Style("/styles/s332.webp"),
                basePrompt: "Forge a modern CSGO-style logo for ''Text''. Use a dynamic crouched soldier or crosshair icon, bold blocky fonts, and dramatic lighting reminiscent of e-sports events."
            },
            {
                src: s3Style("/styles/s333.webp"),
                basePrompt: "Develop a Counter-Strike mascot logo for ''Text''. Portray a special ops figure or assault rifle silhouette, paired with sharp, angular text and intense color contrasts."
            },
            {
                src: s3Style("/styles/s334.webp"),
                basePrompt: "Craft a neon-touched CSGO e-sports logo for ''Text''. Center on a stylish commando mask or pistol, bold stylized fonts, and glowing accents for a tournament-ready look."
            },
            {
                src: s3Style("/styles/s335.webp"),
                basePrompt: "Create a tactical Counter-Strike icon for ''Text''. Feature a menacing CT or T figure with edgy line art, bold uppercase lettering, and steel-gray to neon color transitions."
            },
            {
                src: s3Style("/styles/s336.webp"),
                basePrompt: "Design an aggressive CSGO clan logo for ''Text''. Incorporate a hooded operative or bullet shell motif, with strong color blocks and stylized e-sports typography."
            },
            {
        ...
        "MOBA": [
            {
                ...
                basePrompt: "Create a MOBA-inspired gaming logo for ''Text''. Use vibrant, stylized fonts with character class icons, capturing fast-paced team combat and fantasy adventure."
            },
            {
                src: s3Style("/styles/s371.webp"),
                basePrompt: "Design a dynamic MOBA logo for ''Text''. Incorporate epic fonts, lane or tower motifs, and bold magical or tech elements to showcase high-intensity strategic battles."
            },
            {
                src: s3Style("/styles/s372.webp"),
                basePrompt: "Forge a bold MOBA-themed logo for ''Text''. Blend sweeping, heroic typography with references to minions or battle arenas, highlighting cooperative gameplay and epic showdowns."
            },
            {
                src: s3Style("/styles/s373.webp"),
                basePrompt: "Develop a colorful MOBA logo for ''Text''. Use stylized, energetic letters with champion silhouettes or ability icons, set against a vibrant battlefield backdrop."
            },
            {
                src: s3Style("/styles/s374.webp"),
                basePrompt: "Craft a professional MOBA gaming logo for ''Text''. Combine sleek, modern fonts with layered shield or crest imagery, reflecting tactical team synergy and hero-based strategies."
            },
            {
                src: s3Style("/styles/s375.webp"),
                basePrompt: "Create a stylized MOBA design for ''Text''. Employ bold lettering, mystical power or aura effects, and distinct lane references to channel the thrill of champion warfare."
            },
            {
                src: s3Style("/styles/s376.webp"),
                basePrompt: "Design a fantasy-tech MOBA logo for ''Text''. Merge futuristic and magical elements in the text style, adding small minion or turret icons for a balanced strategic feel."
            },
            {
                src: s3Style("/styles/s377.webp"),
                basePrompt: "Generate a high-energy MOBA logo for ''Text''. Use strong, angular fonts with swirling spells or sword silhouettes, capturing the intense clash of heroes."
            },
            {
                src: s3Style("/styles/s378.webp"),
                basePrompt: "Develop a creative MOBA-themed logo for ''Text''. Incorporate realm-based motifs, hero weapon outlines, and color-coded team bars for a dynamic eSports presence."
            },
            {
                src: s3Style("/styles/s379.webp"),
                basePrompt: "Produce a modern MOBA logo for ''Text''. Utilize stylized, heroic typography, faint lightning or elemental effects, and subtle references to lane or jungle conflicts."
            },
            {
                src: s3Style("/styles/s380.webp"),
                basePrompt: "Design a MOBA-inspired mascot logo for ''Text''. Feature a stylized hero champion or creature with vivid outlines, epic fonts, and dynamic color transitions."
            },
            {
                src: s3Style("/styles/s381.webp"),
                basePrompt: "Create a fast-paced MOBA crest for ''Text''. Showcase a fierce warrior or mage icon in bold line art, with energetic, angled fonts and glowing accents."
            },
            {
                src: s3Style("/styles/s382.webp"),
                basePrompt: "Forge a heroic MOBA emblem for ''Text''. Combine a mythical fighter or beast silhouette, neon highlights, and e-sports style typography for a competitive edge."
            },
            {
                src: s3Style("/styles/s383.webp"),
                basePrompt: "Develop a dynamic MOBA logo for ''Text''. Use a champion-like figure or creature, thick cartoonish outlines, and bold team-font design with magical color flares."
            },
            {
                src: s3Style("/styles/s384.webp"),
                basePrompt: "Craft a vibrant e-sports logo for ''Text''. Center on a MOBA hero or monster, big eyes or dramatic expression, and blocky letters for intense, team-based action."
            },
            {
                src: s3Style("/styles/s385.webp"),
                basePrompt: "Create a stylized MOBA icon for ''Text''. Show a fierce champion or summoner creature with glowing aura, and a modern, edgy font that commands attention."
            },
            {
                src: s3Style("/styles/s386.webp"),
                basePrompt: "Design a sleek MOBA mascot logo for ''Text''. Incorporate a strong fantasy or sci-fi hero silhouette, neon arcs, and futuristic e-sports typography."
            },
            {
                src: s3Style("/styles/s387.webp"),
                basePrompt: "Generate a bold MOBA-themed design for ''Text''. Feature a dynamic pose of a champion or minion, dramatic outlines, and fierce stylized text that pops."
            },
            {
                src: s3Style("/styles/s388.webp"),
                basePrompt: "Develop a competitive MOBA crest for ''Text''. Use a central hero or epic beast with aura effects, framed by angled, heroic text in bright e-sports colors."
            },
            {
                src: s3Style("/styles/s389.webp"),
                basePrompt: "Produce a modern MOBA clan logo for ''Text''. Highlight a legendary champion or summoner staff, layered neon shapes, and a crisp uppercase font for tournament appeal."
            }
        ],
        "Shooters": [
            {
        ...
        "Emblem": [
            {
                ...
                basePrompt: "Design a regal emblem logo for ''Text''. Use ornate shields, crests, and bold typography, capturing an epic, old-world gaming aesthetic."
            },
            {
                src: s3Style("/styles/s421.webp"),
                basePrompt: "Create a classic emblem-styled logo for ''Text''. Incorporate heraldic symbols, filigree accents, and a strong central shield for a timeless fantasy feel."
            },
            {
                src: s3Style("/styles/s422.webp"),
                basePrompt: "Forge a robust emblem gaming logo for ''Text''. Use powerful, symmetrical iconography, thick lines, and grand typography reminiscent of knightly banners."
            },
            {
                src: s3Style("/styles/s423.webp"),
                basePrompt: "Develop a modern emblem design for ''Text''. Blend crisp geometry with subtle metallic textures, anchored by an iconic crest that screams competitive royalty."
            },
            {
                src: s3Style("/styles/s424.webp"),
                basePrompt: "Craft an intricate emblem-based logo for ''Text''. Incorporate layered shield motifs, filigree flourishes, and bold, stylized fonts for a polished medieval flair."
            },
            {
                src: s3Style("/styles/s425.webp"),
                basePrompt: "Create a commanding emblem logo for ''Text''. Feature majestic animals or mythical creatures, elegant heraldry, and strong text that stands out in eSports contexts."
            },
            {
                src: s3Style("/styles/s426.webp"),
                basePrompt: "Design a stylized emblem gaming logo for ''Text''. Use dynamic shapes, regal borders, and crisp lettering to portray a noble yet modern gaming identity."
            },
            {
                src: s3Style("/styles/s427.webp"),
                basePrompt: "Produce a triumphant emblem-themed logo for ''Text''. Merge bold crest outlines, subtle gem or metal effects, and powerful, uppercase fonts for a conquering vibe."
            },
            {
                src: s3Style("/styles/s428.webp"),
                basePrompt: "Develop a creative emblem logo for ''Text''. Combine knightly shield silhouettes, swirling scrollwork, and a heroic color palette to emphasize epic grandeur."
            },
            {
                src: s3Style("/styles/s429.webp"),
                basePrompt: "Generate a modern-fantasy emblem for ''Text''. Fuse ornate, symmetrical shapes with futuristic lines, and add a strong typographic focal point that suits eSports."
            },
            {
                src: s3Style("/styles/s430.webp"),
                basePrompt: "Design a regal emblem logo for ''Text''. Include a stylized mascot or creature within a shield, with bold e-sports lines and ornate, heroic text."
            },
            {
                src: s3Style("/styles/s431.webp"),
                basePrompt: "Create a classic emblem-styled gaming logo for ''Text''. Incorporate heraldic symbols, filigree accents, and a strong central shield for a timeless fantasy feel."
            },
            {
                src: s3Style("/styles/s432.webp"),
                basePrompt: "Forge a robust e-sports emblem for ''Text''. Use powerful, symmetrical iconography, thick lines, and grand typography reminiscent of knightly banners."
            },
            {
            ...
            },
            {
                ...
                basePrompt: "Create a commanding emblem logo for ''Text''. Use a roaring beast or armored figure, dramatic highlight strokes, and a thick typeface that stands out in e-sports."
            },
            /*{
            ...
            },
            {
                ...
                basePrompt: "Develop a creative crest for ''Text''. Combine knightly shield silhouettes, swirling scrollwork, and a heroic color palette to emphasize epic grandeur."
            },
            {
                src: s3Style("/styles/s439.webp"),
                basePrompt: "Generate a modern-fantasy emblem for ''Text''. Fuse ornate, symmetrical shapes with futuristic lines, and add a strong typographic focal point that suits e-sports."
            }
        ],
        "Kawaii": [
            {
        ...
        "Fantasy": [
            {
                ...
                basePrompt: "Design a whimsical fantasy gaming logo for ''Text''. Use flowing, magical fonts, enchanted forest or crystal motifs, and vibrant, otherworldly colors."
            },
            {
                src: s3Style("/styles/s471.webp"),
                basePrompt: "Create a high-fantasy logo for ''Text''. Incorporate dragon silhouettes, swirling arcane symbols, and bold, medieval-inspired fonts for epic immersion."
            },
            {
                src: s3Style("/styles/s472.webp"),
                basePrompt: "Forge a mystical fantasy logo for ''Text''. Merge glowing runic lettering, ethereal elemental effects, and subtle castle spires for a grand RPG-like style."
            },
            {
                src: s3Style("/styles/s473.webp"),
                basePrompt: "Develop a heroic fantasy gaming logo for ''Text''. Use proud, angular text, sword or shield icons, and sweeping magical energy lines to convey epic quests."
            },
            {
                src: s3Style("/styles/s474.webp"),
                basePrompt: "Craft an enchanted fantasy logo for ''Text''. Blend ornate, serif fonts with cosmic stardust or fairy-like glows, reflecting a dreamlike, storybook realm."
            },
            {
                src: s3Style("/styles/s475.webp"),
                basePrompt: "Create a professional fantasy logo for ''Text''. Employ polished medieval typography, creature silhouettes, and a regal color scheme for a premium RPG appeal."
            },
            {
                src: s3Style("/styles/s476.webp"),
                basePrompt: "Design a dark fantasy gaming logo for ''Text''. Combine sinister, jagged fonts, spiky demon horns, or eerie glowing eyes for a menacing, gothic presence."
            },
            {
                src: s3Style("/styles/s477.webp"),
                basePrompt: "Produce an ethereal fantasy logo for ''Text''. Use wispy, flowing lettering, star or moon motifs, and a soft pastel glow to evoke a magical wonderland."
            },
            {
                src: s3Style("/styles/s478.webp"),
                basePrompt: "Develop a colorful fantasy design for ''Text''. Merge vibrant arcane runes, gemlike crystals, and lively calligraphy that captures epic realm adventures."
            },
            {
                src: s3Style("/styles/s479.webp"),
                basePrompt: "Generate a modern fantasy gaming logo for ''Text''. Integrate clean, stylized fonts with subtle mystical shapes or creatures, creating a striking, eSports-ready style."
            },
            {
                src: s3Style("/styles/s480.webp"),
                basePrompt: "Design a whimsical fantasy mascot logo for ''Text''. Feature a playful wizard, dragon, or elf in bright lines, with bold e-sports text and vibrant magical accents."
            },
            {
                src: s3Style("/styles/s481.webp"),
                basePrompt: "Create a high-fantasy gaming logo for ''Text''. Integrate a majestic creature or armored knight, swirling arcane effects, and eye-catching bold typography."
            },
            {
                src: s3Style("/styles/s482.webp"),
                basePrompt: "Forge a mystical fantasy emblem for ''Text''. Combine glowing runic lettering, ethereal elemental effects, and subtle castle spires for a grand RPG-like style."
            },
            {
                src: s3Style("/styles/s483.webp"),
                basePrompt: "Develop a heroic fantasy clan logo for ''Text''. Show a sword-wielding warrior or mythical beast, set against luminous shapes and bold angled fonts."
            },
            {
                src: s3Style("/styles/s484.webp"),
                basePrompt: "Craft an enchanted fantasy design for ''Text''. Blend ornate, serif fonts with cosmic stardust or fairy-like glows, reflecting a dreamlike, storybook realm."
            },
            {
                src: s3Style("/styles/s485.webp"),
                basePrompt: "Create a professional fantasy gaming logo for ''Text''. Incorporate regal medieval fonts, mythical silhouettes, and a strong dynamic shading for premium RPG appeal."
            },
            {
                src: s3Style("/styles/s486.webp"),
                basePrompt: "Design a dark fantasy mascot for ''Text''. Include a sinister demon or undead sorcerer, sharp neon highlights, and aggressive e-sports typography."
            },
            {
                src: s3Style("/styles/s487.webp"),
                basePrompt: "Produce an ethereal fantasy logo for ''Text''. Use starry or moonlit accents, a magical creature silhouette, and softly glowing bold text for a dreamy vibe."
            },
            {
                src: s3Style("/styles/s488.webp"),
                basePrompt: "Develop a colorful fantasy e-sports logo for ''Text''. Merge rainbow-hued runes, a lively monster or wizard, and impactful cartoon-like text that leaps out."
            },
            {
                src: s3Style("/styles/s489.webp"),
                basePrompt: "Generate a modern fantasy gaming logo for ''Text''. Portray a futuristic mage or draconic beast in metallic outlines, combined with chunky, confident lettering."
            }
        ],
        "Horror": [
            {
        ...
        "Black": [
            {
                ...
                basePrompt: "Design a sleek black-themed gaming logo for ''Text''. Use bold, futuristic typography with glossy black finishes and subtle neon or metallic accents. Place it against a dark background to project power and sophistication."
            },
            {
                src: s3Style("/styles/s501.webp"),
                basePrompt: "Create a black-themed gaming logo for ''Text''. Employ bold, edgy fonts with matte black accents, minimal neon highlights, and subtle dark textures to convey a stealthy, high-end style."
            },
            {
                src: s3Style("/styles/s502.webp"),
                basePrompt: "Design a professional black gaming logo for ''Text''. Utilize sleek, modern typography with glossy black edges on a deep black background. Add subtle digital or metallic detailing for a cutting-edge feel."
            },
            {
                src: s3Style("/styles/s503.webp"),
                basePrompt: "Create a minimalist black gaming logo for ''Text''. Use simple, bold black typography accented by faint neon lines or glitch effects. Position it on a black backdrop to highlight the brand's sleek, competitive edge."
            },
            {
                src: s3Style("/styles/s504.webp"),
                basePrompt: "Design a stylish black-themed gaming logo for ''Text''. Employ bold, angular fonts with matte black finishes and subtle futuristic lines. Place it on a sleek black background to command attention."
            },
            {
                src: s3Style("/styles/s505.webp"),
                basePrompt: "Create a professional black gaming logo for ''Text''. Use sleek, modern fonts with strong black outlines and subtle geometric shapes on a deep black backdrop, projecting authority and a high-tech aesthetic."
            },
            {
                src: s3Style("/styles/s506.webp"),
                basePrompt: "Design a minimalist black-themed gaming logo for ''Text''. Employ clean, modern lettering with subtle dark overlays or minimal neon highlights. Set it against a black background to convey an understated, high-tech vibe."
            },
            {
                src: s3Style("/styles/s507.webp"),
                basePrompt: "Create a sleek black-themed gaming logo for ''Text''. Use bold, futuristic fonts with glossy black detailing and muted neon accents. Place it on a dark backdrop for a stealthy, powerful presence."
            },
            {
                src: s3Style("/styles/s508.webp"),
                basePrompt: "Design a modern black gaming logo for ''Text''. Employ streamlined black typography with subtle neon outlines, set against a minimalist dark background to evoke a refined, high-tech gaming aura."
            },
            {
                src: s3Style("/styles/s509.webp"),
                basePrompt: "Create a stylish black-themed gaming logo for ''Text''. Use bold, minimalist black fonts with faint metallic or neon touches on a deep black backdrop, ensuring a sleek, contemporary gaming look."
            }
        ],
        "Blue": [
            {
                src: s3Style("/styles/s510.webp"),
                basePrompt: "Design a cool blue-themed gaming logo for ''Text''. Use sleek, futuristic fonts in electric shades of blue with dynamic wave motifs. Place it against a calming yet energetic blue backdrop for a crisp, modern style."
            },
            {
                src: s3Style("/styles/s511.webp"),
                basePrompt: "Create a blue-themed gaming logo for ''Text''. Incorporate edgy fonts with shimmering blue highlights and subtle wave or bubble designs. Position it on a serene but lively blue background for an agile, fluid vibe."
            },
            {
                src: s3Style("/styles/s512.webp"),
                basePrompt: "Design a professional blue gaming logo for ''Text''. Employ modern, tech-savvy fonts layered in varying shades of blue, accented by stylized wave or droplet shapes. Set it on a calming, futuristic blue backdrop."
            },
            {
                src: s3Style("/styles/s513.webp"),
                basePrompt: "Create a minimalist blue gaming logo for ''Text''. Use clean, edgy blue typography with faint glitch or wave lines. Place it on a serene yet electric blue backdrop for a sleek, contemporary gaming feel."
            },
            {
                src: s3Style("/styles/s514.webp"),
                basePrompt: "Design a stylish blue-themed gaming logo for ''Text''. Employ smooth, futuristic blue fonts with fluid wave accents. Position it on a sleek, neon-blue background for a modern, energetic style."
            },
            {
                src: s3Style("/styles/s515.webp"),
                basePrompt: "Create a professional blue gaming logo for ''Text''. Use polished, modern fonts with bold, cobalt-blue edges and fluid wave motifs. Set it on a serene yet futuristic blue gradient to reflect advanced gameplay."
            },
            {
                src: s3Style("/styles/s516.webp"),
                basePrompt: "Design a stylized blue gaming logo for ''Text''. Utilize luminous, cyber-blue typography with subtle wave or bubble illusions. Place it against a vibrant, neon-blue background for a captivating, futuristic vibe."
            },
            {
                src: s3Style("/styles/s517.webp"),
                basePrompt: "Create a vibrant blue-themed gaming logo for ''Text''. Use dynamic, energetic blue fonts with shimmering wave outlines and subtle water sparks. Position it on a bright, immersive blue backdrop for strong visual impact."
            },
            {
                src: s3Style("/styles/s518.webp"),
                basePrompt: "Design a creative blue gaming logo for ''Text''. Employ streamlined fonts with futuristic blue gradients, integrating wave or bubble highlights. Place it on a radiant blue background to showcase innovative gaming appeal."
            },
            {
                src: s3Style("/styles/s519.webp"),
                basePrompt: "Create a modern blue-themed gaming logo for ''Text''. Use sleek, high-tech fonts with bold cyan or royal-blue outlines. Incorporate subtle wave or droplet motifs, set against a luminous, tranquil background for a refined, immersive style."
            }
        ],
        "Green": [
            {
                src: s3Style("/styles/s520.webp"),
                basePrompt: "Design a green-themed gaming logo for ''Text''. Use bold, futuristic fonts with neon-green highlights, referencing forests or toxic slime for an edgy gamer vibe."
            },
            {
                src: s3Style("/styles/s521.webp"),
                basePrompt: "Create a vibrant green logo for ''Text''. Merge energetic, angular lettering with leaf or vine motifs, set against a fresh, electric color palette."
            },
            {
                src: s3Style("/styles/s522.webp"),
                basePrompt: "Forge a sleek green gaming logo for ''Text''. Employ sharp typography in lime or emerald hues, enhanced by subtle wave or glow effects to evoke a futuristic style."
            },
            {
                src: s3Style("/styles/s523.webp"),
                basePrompt: "Develop a modern green design for ''Text''. Combine crisp, edgy lettering with digital circuit lines or leaf silhouettes for a tech-inspired, eco-friendly twist."
            },
            {
                src: s3Style("/styles/s524.webp"),
                basePrompt: "Craft a neon-green gaming logo for ''Text''. Use intense glow or glitch details, plus dynamic shapes that accentuate a fast-paced, energetic identity."
            },
            {
                src: s3Style("/styles/s525.webp"),
                basePrompt: "Create a professional green-themed logo for ''Text''. Use smooth, polished fonts with gradient green edges, adding subtle nature or biohazard icons for gamer flair."
            },
            {
                src: s3Style("/styles/s526.webp"),
                basePrompt: "Design a bold green logo for ''Text''. Pair strong, blocky letters with swirling leaf or dragon-scale motifs, reflecting both nature and power."
            },
            {
                src: s3Style("/styles/s527.webp"),
                basePrompt: "Generate a stylized green gaming logo for ''Text''. Combine edgy fonts in neon or forest green with swirling patterns, referencing growth or poison elements."
            },
            {
                src: s3Style("/styles/s528.webp"),
                basePrompt: "Develop a futuristic green logo for ''Text''. Merge angular, Tron-like typography with vivid lime highlights, giving an advanced, sci-fi aura."
            },
            {
                src: s3Style("/styles/s529.webp"),
                basePrompt: "Produce a creative green-themed design for ''Text''. Use dynamic, geometric lettering in emerald or lime, adding minimal leaf or lightning icons to capture raw, natural energy."
            },
            {
                src: s3Style("/styles/s530.webp"),
                basePrompt: "Design a green-themed e-sports mascot logo for ''Text''. Feature a toxic beast or leafy creature, neon-lime outlines, and bold, gritty text for a fierce impression."
            },
            {
                src: s3Style("/styles/s531.webp"),
                basePrompt: "Create a vibrant green gaming logo for ''Text''. Use a venomous snake or radioactive motif, angular fonts, and contrasting dark tones for an edgy style."
            },
            {
                src: s3Style("/styles/s532.webp"),
                basePrompt: "Forge a sleek green design for ''Text''. Combine electric lettering in emerald or neon-lime with a stylized reptile, alien, or slime creature in bold lines."
            },
            {
                src: s3Style("/styles/s533.webp"),
                basePrompt: "Develop a modern green e-sports logo for ''Text''. Focus on a warrior or monster sporting green power effects, paired with aggressive blocky fonts."
            },
            {
                src: s3Style("/styles/s534.webp"),
                basePrompt: "Craft a neon-toxic logo for ''Text''. Feature radioactive, green fumes or slime drips, thick outlines, and edgy uppercase text for a rebellious gamer look."
            },
            {
                src: s3Style("/styles/s535.webp"),
                basePrompt: "Create a professional green-themed badge for ''Text''. Use a stylized forest spirit or gas-masked figure, metallic highlights, and strong, crisp fonts for e-sports polish."
            },
            {
                src: s3Style("/styles/s536.webp"),
                basePrompt: "Design a bold green mascot logo for ''Text''. Portray a fierce plant creature or serpent with dynamic shading, combined with heavy, modern type for an epic effect."
            },
            {
                src: s3Style("/styles/s537.webp"),
                basePrompt: "Generate a stylized green e-sports logo for ''Text''. Combine edgy fonts in neon or forest green with swirling patterns, referencing growth or poison elements."
            },
            {
                src: s3Style("/styles/s538.webp"),
                basePrompt: "Develop a futuristic green crest for ''Text''. Combine a slick, robotic creature or mech with neon-lime edges, anchored by an authoritative uppercase font."
            },
            {
        ...
        "Dia de Muertos": [
            {
                ...
                basePrompt: "Design a vibrant Dia de Muertos-themed gaming logo for ''Text''. Use ornate, decorative fonts with colorful sugar skulls and marigolds. Emphasize festive, celebratory energy."
            },
            {
                src: s3Style("/styles/s551.webp"),
                basePrompt: "Create a Dia de Muertos-inspired logo for ''Text''. The text ''Text'' should use decorative typography with bright sugar skull motifs and floral accents, evoking a fun yet respectful holiday vibe."
            },
            {
                src: s3Style("/styles/s552.webp"),
                basePrompt: "Forge a gaming logo for ''Text'' themed around Dia de Muertos. Combine ornate, lively fonts with sugar skull designs and marigold highlights for a culturally rich, festive look."
            },
            {
                src: s3Style("/styles/s553.webp"),
                basePrompt: "Develop a dynamic Dia de Muertos logo for ''Text''. Use intricate, colorful fonts adorned with skulls and floral patterns. Add bold, celebratory color pops for holiday flair."
            },
            {
                src: s3Style("/styles/s554.webp"),
                basePrompt: "Craft a Dia de Muertos-inspired gaming logo for ''Text''. Integrate ornate, decorative typography with sugar skull icons, vibrant flowers, and playful patterns, reflecting festive traditions."
            },
            /*{
            ...
            },*/
            {
                ...
                basePrompt: "Create a stylized Dia de Muertos gaming logo for ''Text''. Combine ornate, folk-art-style lettering with colorful skeletal motifs and floral flourishes, capturing vibrant cultural energy."
            },
            {
                src: s3Style("/styles/s557.webp"),
                basePrompt: "Generate a vivid Dia de Muertos logo for ''Text''. Use decorative, candy-colored fonts, sugar skull themes, and bright marigold accents for a joyous, culturally rich design."
            },
            /*{
            ...
            },*/
            {
                ...
                basePrompt: "Design a modern Dia de Muertos-themed logo for ''Text''. Use stylized lettering and colorful skull graphics, accented by marigolds. Aim for a fun, festive, and respectful holiday touch."
            }
        ],
        "Easter": [
            {
                src: s3Style("/styles/s560.webp"),
                basePrompt: "Design a cheerful Easter-themed gaming logo for ''Text''. Use playful, pastel-toned fonts, bunny silhouettes, and decorated eggs, evoking a lighthearted, spring celebration."
            },
            {
                src: s3Style("/styles/s561.webp"),
                basePrompt: "Create an Easter-inspired logo for ''Text''. Employ soft, pastel lettering with integrated bunnies, eggs, or flower motifs. Showcase a joyful, vibrant holiday spirit."
            },
            {
                src: s3Style("/styles/s562.webp"),
                basePrompt: "Forge a gaming logo for ''Text'' with an Easter theme. Use fun, pastel-colored fonts, bunny ears, and egg designs, set against a bright, celebratory background."
            },
            {
                src: s3Style("/styles/s563.webp"),
                basePrompt: "Develop a dynamic Easter logo for ''Text''. Combine playful, bubble-like text in pastel hues with bunny or egg icons, capturing a lively, family-friendly vibe."
            },
            {
                src: s3Style("/styles/s564.webp"),
                basePrompt: "Craft an Easter-themed gaming logo for ''Text''. Use pastel, whimsical fonts, integrated rabbits and eggs, and bright floral accents, reflecting the renewal of spring."
            },
            /*{
            ...
            },*/
            {
                ...
                basePrompt: "Create a stylized Easter gaming logo for ''Text''. Feature bubbly, pastel fonts, integrated Easter icons, and playful springtime hues to evoke holiday excitement."
            },
            {
                src: s3Style("/styles/s567.webp"),
                basePrompt: "Generate a vibrant Easter-themed logo for ''Text''. Combine pastel, cartoon-like lettering, bunny motifs, and decorated egg shapes, capturing a cheerful, celebratory tone."
            },
            /*{
            ...
            },*/
            {
                ...
                basePrompt: "Design a modern Easter-themed gaming logo for ''Text''. Employ light, pastel-toned typography with subtle rabbit or egg icons, highlighting a fresh, lively spring ambiance."
            }
        ],
        "Halloween": [
            {
                src: s3Style("/styles/s570.webp"),
                basePrompt: "Design a spooky Halloween-themed gaming logo for ''Text''. Use jagged, eerie fonts with orange accents, integrating bats, pumpkins, or spiderwebs on a dark, haunted backdrop."
            },
            {
                src: s3Style("/styles/s571.webp"),
                basePrompt: "Create a Halloween-inspired logo for ''Text''. Employ gothic, horror-style lettering, jack-o'-lanterns, bats, or spiderweb motifs. Set it against a chilling, ominous backdrop."
            },
            {
                src: s3Style("/styles/s572.webp"),
                basePrompt: "Forge a high-impact Halloween gaming logo for ''Text''. Use sharp, haunted fonts with orange and black contrasts, referencing pumpkins or ghoulish silhouettes."
            },
            {
                src: s3Style("/styles/s573.webp"),
                basePrompt: "Develop a dynamic Halloween logo for ''Text''. Combine bold, spooky text, jack-o'-lantern graphics, and dramatic color flares for a menacing yet festive vibe."
            },
            {
                src: s3Style("/styles/s574.webp"),
                basePrompt: "Craft a Halloween-themed gaming logo for ''Text''. Use jagged, eerie fonts, spiderweb overlays, and bright orange highlights to convey a fun yet frightening feel."
            },
            {
                src: s3Style("/styles/s575.webp"),
                basePrompt: "Design a professional Halloween logo for ''Text''. Integrate haunting, stylized fonts, pumpkin or bat motifs, and subtle neon glows, reflecting a darkly festive aesthetic."
            },
            {
                src: s3Style("/styles/s576.webp"),
                basePrompt: "Create a stylized Halloween logo for ''Text''. Use eerie, jagged text with ghostly or skeletal motifs, layered on a foggy, neon-lit background for supernatural flair."
            },
            {
                src: s3Style("/styles/s577.webp"),
                basePrompt: "Generate a vibrant Halloween-themed logo for ''Text''. Combine spooky, angular fonts, candy-bright oranges, and iconic items like pumpkins or bats for a playful horror vibe."
            },
            {
                src: s3Style("/styles/s578.webp"),
                basePrompt: "Develop a creative Halloween logo for ''Text''. Merge bold, spooky fonts, grinning pumpkins, and creeping vines or webs. Aim for a spirited, haunted celebration feel."
            },
            {
                src: s3Style("/styles/s579.webp"),
                basePrompt: "Design a modern Halloween-themed gaming logo for ''Text''. Use jagged, cryptic lettering with subtle neon highlights, plus bat or spiderweb motifs, channeling an eerie festive aura."
            }
        ],
        "Holiday": [
            {
                src: s3Style("/styles/s580.webp"),
                basePrompt: "Design a joyful holiday-themed gaming logo for ''Text''. Use festive fonts, playful snowflake or ornament details, and bright, celebratory colors."
            },
            {
                src: s3Style("/styles/s581.webp"),
                basePrompt: "Create a festive holiday logo for ''Text''. Merge cheerful lettering, candy cane stripes or gift box elements, and a warm, glowing backdrop for a cozy gaming vibe."
            },
            {
                src: s3Style("/styles/s582.webp"),
                basePrompt: "Forge a winter wonderland holiday logo for ''Text''. Combine frosty, playful typography, ice crystal effects, and subtle gaming icons with a bright holiday palette."
            },
            {
                src: s3Style("/styles/s583.webp"),
                basePrompt: "Develop a dynamic holiday-themed design for ''Text''. Use bold, celebratory fonts, snow-laced edges, and stylized ornaments or bells for a merry gaming style."
            },
            {
                src: s3Style("/styles/s584.webp"),
                basePrompt: "Craft a modern holiday gaming logo for ''Text''. Integrate crisp, edgy lettering with sleek snowflake or star motifs, using neon reds and greens for an eSports-friendly twist."
            },
            /*{
            ...
            },*/
            {
                ...
                basePrompt: "Design a celebratory holiday logo for ''Text''. Merge bright, energetic lettering, scattered confetti, and minimal gaming references, capturing a year-end party vibe."
            },
            {
                src: s3Style("/styles/s587.webp"),
                basePrompt: "Generate a stylized holiday-themed logo for ''Text''. Use frosted, fun fonts, string lights or candy icons, and vibrant colors for a warm, festive gaming approach."
            },
            {
                src: s3Style("/styles/s588.webp"),
                basePrompt: "Develop a cheerful holiday gaming logo for ''Text''. Blend playful typography, small gift box or mistletoe details, and a bold, jolly color scheme."
            },
            {
                src: s3Style("/styles/s589.webp"),
                basePrompt: "Produce a sleek holiday logo for ''Text''. Utilize modern, minimal fonts with subtle holiday icons (like bells or ribbons) and a refined color palette for a classy seasonal feel."
            },
            {
                src: s3Style("/styles/s590.webp"),
                basePrompt: "Design a joyful holiday mascot logo for ''Text''. Use a fun character like a snowman or elf with thick outlines, bright reds and greens, and playful e-sports text."
            },
            {
                src: s3Style("/styles/s591.webp"),
                basePrompt: "Create a festive holiday logo for ''Text''. Combine a cheerful reindeer or ornament mascot, candy-cane patterns, and bold, cartoony lettering for a merry vibe."
            },
            {
                src: s3Style("/styles/s592.webp"),
                basePrompt: "Forge a winter wonderland e-sports logo for ''Text''. Combine frosty, playful typography, ice crystal effects, and subtle gaming icons with a bright holiday palette."
            },
            {
                src: s3Style("/styles/s593.webp"),
                basePrompt: "Develop a dynamic holiday-themed design for ''Text''. Show a bell- or toy-inspired mascot with neon edges, plus strong uppercase fonts for a party-like feel."
            },
            {
                src: s3Style("/styles/s594.webp"),
                basePrompt: "Craft a modern holiday gaming logo for ''Text''. Combine a stylized sleigh or candy motif, bright contrasting colors, and thick lines for a cheerful e-sports style."
            },
            /*{
            ...
            },*/
            {
                ...
                basePrompt: "Design a celebratory holiday logo for ''Text''. Merge fireworks or confetti with a jolly mascot (like a gingerbread man), plus dynamic e-sports fonts for year-end excitement."
            },
            {
                src: s3Style("/styles/s597.webp"),
                basePrompt: "Generate a stylized holiday-themed mascot for ''Text''. Use frosted, fun fonts, string lights or candy icons, and vibrant colors for a warm, festive gaming approach."
            },
            {
                src: s3Style("/styles/s598.webp"),
                basePrompt: "Develop a cheerful holiday gaming logo for ''Text''. Incorporate a comedic holiday figure (reindeer or snow monster) with big eyes, neon highlights, and thick text lines."
            },
            {
                src: s3Style("/styles/s599.webp"),
                basePrompt: "Produce a sleek festive logo for ''Text''. Fuse modern, minimal fonts with subtle holiday icons (bells or ribbons) and a classy color palette for a refined seasonal approach."
            }
        ],
        "Valentine's Day": [
            {
        ...
        "Brazil": [
            {
                ...
                basePrompt: "Design a vibrant Brazil-themed gaming logo for ''Text''. Use bold, colorful fonts with Brazilian flag elements, tropical leaves, and samba-inspired patterns, evoking a lively, cultural flair."
            },
            {
                src: s3Style("/styles/s601.webp"),
                basePrompt: "Create a Brazil-inspired logo for ''Text''. Incorporate bright, festive lettering, tropical flora, and lively colors. Include subtle references to Brazilian spirit or carnival motifs."
            },
            {
                src: s3Style("/styles/s602.webp"),
                basePrompt: "Forge a gaming logo for ''Text'' based on Brazilian culture. Utilize bold, tropical fonts with samba vibes, Brazilian flag accents, and lush leaf silhouettes against an energetic background."
            },
            {
                src: s3Style("/styles/s603.webp"),
                basePrompt: "Develop a dynamic Brazil-themed logo for ''Text''. Merge bright, stylized typography, carnival-infused designs, and tropical icons, reflecting the country's upbeat, rhythmic energy."
            },
            {
                src: s3Style("/styles/s604.webp"),
                basePrompt: "Craft a culturally rich Brazil logo for ''Text''. Combine bold, colorful fonts, the Brazilian flag, and tropical references like palm leaves, culminating in a vivid, celebratory aura."
            },
            {
                src: s3Style("/styles/s605.webp"),
                basePrompt: "Design a polished Brazil-inspired gaming logo for ''Text''. Use strong, vibrant lettering with samba or carnival motifs, accentuating the country's dynamic spirit and festive color palette."
            },
            /*{
            ...
            },*/
            {
                ...
                basePrompt: "Generate a vibrant Brazil-themed gaming logo for ''Text''. Employ bold, festive letters with bright color contrasts and tropical or samba-inspired icons, channeling energetic carnival vibes."
            },
            /*{
            ...
            },*/
            {
                ...
                basePrompt: "Design a modern Brazil-inspired gaming logo for ''Text''. Use bold, colorful fonts, carnival shapes, and subtle flag details. Exude vibrant excitement and cultural pride."
            }
        ],
        "Patriotic": [
            {
                src: s3Style("/styles/s620.webp"),
                basePrompt: "Design a bold patriotic gaming logo for ''Text''. Use national symbols like flags or eagles, integrated into strong, national-colored fonts. Convey pride and unity."
            },
            {
                src: s3Style("/styles/s621.webp"),
                basePrompt: "Create a patriotic-themed logo for ''Text''. Employ robust, national-hued lettering, referencing iconic emblems or stars. Set against a proud, celebratory backdrop."
            },
            {
                src: s3Style("/styles/s622.webp"),
                basePrompt: "Forge a patriotic gaming logo for ''Text''. Use bold, dynamic fonts in national colors, plus symbolic flags or eagles, evoking a spirit of unity and competitive pride."
            },
            {
                src: s3Style("/styles/s623.webp"),
                basePrompt: "Develop a striking patriotic logo for ''Text''. Combine stylized, national-colored text with strong imagery like flags or badges for a steadfast, inspiring look."
            },
            {
                src: s3Style("/styles/s624.webp"),
                basePrompt: "Craft a patriotic-themed emblem for ''Text''. Integrate flags, stars, or eagles with bold, national-hued fonts. Convey determination and unity in a competitive arena."
            },
            {
                src: s3Style("/styles/s625.webp"),
                basePrompt: "Design a professional patriotic gaming logo for ''Text''. Use angular, national-colored lettering with iconic symbols (e.g., eagle heads, star shields) for a proud, determined tone."
            },
            {
                src: s3Style("/styles/s626.webp"),
                basePrompt: "Create a stylized patriotic logo for ''Text''. The text ''Text'' should merge bold typography with flag patterns or eagles in motion, channeling a rallying spirit of heroism and victory."
            },
            {
                src: s3Style("/styles/s627.webp"),
                basePrompt: "Generate a vibrant patriotic-themed logo for ''Text''. Use strong, energetic fonts with national flags or badges, set against a dynamic background that celebrates identity and pride."
            },
            {
                src: s3Style("/styles/s628.webp"),
                basePrompt: "Develop a creative patriotic logo for ''Text''. Incorporate eye-catching, national-hued fonts, stars, or eagle silhouettes, radiating unity and competitiveness."
            },
            {
                src: s3Style("/styles/s629.webp"),
                basePrompt: "Design a modern patriotic-inspired gaming logo for ''Text''. Use bold, national-colored typography, integrated flag or eagle icons, and subtle metallic finishes to signify strength and loyalty."
            }
        ]
