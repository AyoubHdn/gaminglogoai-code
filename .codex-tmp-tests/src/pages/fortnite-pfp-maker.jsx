...
const FortnitePfpMakerLandingPage = () => {
    ...
    return (<>
      <Head>
        ...
        <meta name="description" content="Create a custom Fortnite PFP from your photo with our free AI generator! Turn your face into a unique Fortnite-style avatar for Discord, YouTube, or Twitch. Try the #1 Fortnite PFP maker now!"/>
      ...
      <main className="bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-200 overflow-x-hidden">
        ...
        <section className="py-16 md:py-20 bg-white dark:bg-slate-900">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {fortnitePfpExamples.map((example, index) => (<div key={index} className="group relative rounded-lg shadow-lg overflow-hidden aspect-square">
        ...
        <section className="py-16 md:py-24 text-center bg-slate-100 dark:bg-slate-950">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <button onClick={handleStartDesigning} className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-slate-900 font-bold rounded-lg text-lg hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 ease-in-out transform hover:scale-105 shadow-xl hover:shadow-cyan-500/50 focus:outline-none focus:ring-4 focus:ring-cyan-300 focus:ring-opacity-50" id="cta-final-fortnitepfp-to-tool">
              Make My PFP with AI
            </button>
          </div>
        </section>
