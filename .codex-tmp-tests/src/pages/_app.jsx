...
const MyApp = (_a) => {
    ...
    return (<SessionProvider session={session}>
      ...
      <Script id="gtm-script-gaminglogoai" // Unique ID for the script tag
     strategy="afterInteractive" dangerouslySetInnerHTML={{
      ...
      <noscript>
        <iframe src={`https://www.googletagmanager.com/ns.html?id=${GTM_ID_GAMINGLOGOAI}`} height="0" width="0" style={{ display: "none", visibility: "hidden" }} title="Google Tag Manager noscript fallback" // Added title for accessibility
    ></iframe>
      </noscript>
