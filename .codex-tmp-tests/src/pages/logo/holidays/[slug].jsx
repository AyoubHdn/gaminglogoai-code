...
const HolidayLogoPage = ({ holiday, images, slug, relatedItems }) => {
    var _a;
    ...
    const templateProps = {
        ...
        heroImageSrc: ((_a = images[0]) === null || _a === void 0 ? void 0 : _a.src) || "/styles/default-holiday-icon.webp",
...
export const getStaticProps = async ({ params }) => {
    ...
    const matchedHoliday = Object.keys(holidaysData).find((key) => createSlug(key, '-gaming-logo') === slug);
    if (!matchedHoliday)
        return { notFound: true };
    const toHighQuality = (src) => src.replace('.webp', 'e.webp');
    const images = ((_a = holidaysData[matchedHoliday]) === null || _a === void 0 ? void 0 : _a.map(img => (Object.assign(Object.assign({}, img), { src: toHighQuality(img.src) })))) || [];
