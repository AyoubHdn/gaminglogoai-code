...
const GameTitleLogoPage = ({ gameTitle, images, slug, relatedItems }) => {
    var _a;
    ...
    const templateProps = {
        ...
        heroImageSrc: ((_a = images[0]) === null || _a === void 0 ? void 0 : _a.src) || "/styles/default-gaming-icon.webp",
...
export const getStaticProps = async ({ params }) => {
    ...
    const matchedGameTitle = Object.keys(gameTitlesData).find((key) => createSlug(key, '-logo-maker') === slug);
    if (!matchedGameTitle)
        return { notFound: true };
    const toHighQuality = (src) => src.replace('.webp', 'e.webp');
    const images = ((_a = gameTitlesData[matchedGameTitle]) === null || _a === void 0 ? void 0 : _a.map(img => (Object.assign(Object.assign({}, img), { src: toHighQuality(img.src) })))) || [];
