...
const CulturalLogoPage = ({ culture, images, slug, relatedItems }) => {
    var _a, _b;
    ...
    const templateProps = {
        ...
        heroImageSrc: (images && images.length > 0 ? (_b = (_a = images[0]) === null || _a === void 0 ? void 0 : _a.src) !== null && _b !== void 0 ? _b : "/styles/default-cultural-icon.webp" : "/styles/default-cultural-icon.webp"),
        ...
        imageShowcaseGrid: (images === null || images === void 0 ? void 0 : images.slice(0, 8).map(img => ({ src: img.src, alt: `${culture}-inspired esports team logo design` }))) || [],
...
export const getStaticProps = async ({ params }) => {
    ...
    const matchedCulture = Object.keys(culturalData).find((key) => createSlug(key, '-esports-logo') === slug);
    if (!matchedCulture) {
    ...
    const images = ((_a = culturalData[matchedCulture]) === null || _a === void 0 ? void 0 : _a.map(img => (Object.assign(Object.assign({}, img), { src: toHighQuality(img.src) })))) || [];
