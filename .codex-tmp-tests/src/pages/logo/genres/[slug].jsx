...
const GenreLogoPage = ({ genre, images, slug, relatedItems }) => {
    var _a;
...
export const getStaticProps = async ({ params }) => {
    ...
    const matchedGenre = Object.keys(gameGenresData).find((key) => createSlug(key, '-logo-design') === slug);
    if (!matchedGenre)
        return { notFound: true };
    const toHighQuality = (src) => src.replace('.webp', 'e.webp');
    const images = ((_a = gameGenresData[matchedGenre]) === null || _a === void 0 ? void 0 : _a.map(img => (Object.assign(Object.assign({}, img), { src: toHighQuality(img.src) })))) || [];
