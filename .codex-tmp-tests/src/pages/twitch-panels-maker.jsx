...
import { FaMagic, FaBolt, FaImages, FaLayerGroup, FaPaintBrush, FaQuestionCircle, FaChevronRight, } from "react-icons/fa";
const TwitchPanelsLandingPage = () => {
    ...
    const features = [
        {
            ...
            description: "Create professional Twitch panels like About, Donate, Rules, Specs, and more using AI.",
            icon: <FaMagic className="h-10 w-10"/>,
        },
        {
            title: "Perfect Twitch Size",
            description: "Every panel is generated in the official Twitch panel size: 320×100 pixels.",
            icon: <FaImages className="h-10 w-10"/>,
        },
        {
            title: "Text-Only Panels",
            description: "No logos or uploads needed. Just type the text you want on your panel.",
            icon: <FaLayerGroup className="h-10 w-10"/>,
        },
        {
            title: "Multiple Styles",
            description: "Choose from Minimal, Neon, Dark, and Gradient panel styles.",
            icon: <FaPaintBrush className="h-10 w-10"/>,
        },
        {
            title: "AI Enhancement",
            description: "Upgrade your panel with AI polish for sharper text, glow, contrast, and modern UI.",
            icon: <FaBolt className="h-10 w-10"/>,
        },
        {
            title: "Instant Download",
            description: "Generate, preview, download, and share your panel in seconds.",
    ...
    return (<>
      <Head>
        ...
        <meta name="description" content="Create clean, neon, dark, and gradient Twitch panels with AI. Text-only panels in perfect 320×100 size."/>
        <link rel="canonical" href="https://gaminglogoai.com/twitch-panels-maker"/>
      ...
      <main className="bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-200">
        ...
        <section className="relative py-20 md:py-28 text-center text-white overflow-hidden">
          ...
          <div className="relative z-20 px-4 max-w-3xl mx-auto">
            ...
            <button onClick={handleStart} className="px-8 py-4 bg-gradient-to-r from-purple-500 to-purple-700 text-white font-bold rounded-lg text-lg hover:scale-105 transition-all shadow-lg">
        ...
        <section className="py-20 bg-slate-50 dark:bg-slate-950">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
              {examplePanels.map((ex, i) => (<div key={i} className="rounded-lg overflow-hidden shadow-lg bg-white dark:bg-slate-800 p-2">
                  <Image src={ex.src} alt={ex.caption} width={320} height={100} className="rounded" unoptimized/>
        ...
        <section className="py-16 bg-white dark:bg-slate-900">
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <div className="space-y-4">
              {faq.map((item, idx) => (<details key={idx} className="p-4 bg-slate-50 dark:bg-slate-800 rounded-lg border cursor-pointer" open={idx === 0}>
        ...
        <section className="py-20 text-center bg-gradient-to-tr from-indigo-900 via-purple-950 to-slate-900 text-white">
          ...
          <button onClick={handleStart} className="px-10 py-4 bg-gradient-to-r from-purple-500 to-purple-700 text-white font-bold rounded-lg text-xl hover:scale-105 transition-all shadow-xl">
