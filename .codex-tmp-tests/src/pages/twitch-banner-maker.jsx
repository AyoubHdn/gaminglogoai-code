...
import { FaPaintBrush, FaBolt, FaImages, FaUsers, FaCogs, FaMagic, FaQuestionCircle, FaChevronRight, } from "react-icons/fa";
const TwitchBannerLandingPage = () => {
    const router = useRouter();
    const handleStart = () => {
        void router.push("/banner-maker");
    };
    const features = [
        {
    ...
    const faq = [
        {
            ...
            a: "You get 1 free credit after signing in, which you can put toward your first Twitch banner or use on other tools. Twitch banner generation currently costs 3 credits, and additional credits are required to create more banners.",
        },
        {
    ...
    return (<>
      <Head>
        ...
        <meta name="description" content="Create custom Twitch banners with your name, tagline, and logo. Fully AI-generated in 1200×480 resolution. Choose from clean, neon, bold, esports, and more styles."/>
      ...
      <main className="bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-200">
        ...
        <section className="relative py-20 md:py-32 text-center text-white overflow-hidden">
          <Image src="/twitch/twitch-banner-bg.webp" alt="Twitch banner background" layout="fill" objectFit="cover" className="opacity-30 dark:opacity-20" unoptimized/>
          ...
          <div className="relative z-20 px-4 max-w-3xl mx-auto">
            ...
            <button onClick={handleStart} className="px-8 py-4 bg-gradient-to-r from-purple-500 to-purple-700 dark:from-cyan-400 dark:to-cyan-600 text-white font-bold rounded-lg text-lg hover:scale-105 transition-all shadow-lg">
        ...
        <section className="py-16 bg-white dark:bg-slate-900">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((f) => (<div key={f.title} className="p-6 bg-slate-50 dark:bg-slate-800/60 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700/50 flex">
        ...
        <section className="py-20 bg-slate-50 dark:bg-slate-950">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {exampleShowcase.map((ex, i) => (<div key={i} className="group relative rounded-lg overflow-hidden shadow-lg aspect-video">
                  <Image src={ex.src} alt={ex.caption} layout="fill" objectFit="cover" className="group-hover:scale-110 transition-transform duration-500"/>
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="rounded-xl overflow-hidden shadow-lg border border-slate-200 dark:border-slate-700">
                ...
                <Image src="/twitch/enhance-before.webp" alt="Twitch banner before AI enhancement" width={1200} height={480} className="w-full h-auto" unoptimized/>
              </div>
              ...
              <div className="rounded-xl overflow-hidden shadow-xl border border-purple-500/40">
                ...
                <Image src="/twitch/enhance-after.webp" alt="Twitch banner after AI enhancement" width={1200} height={480} className="w-full h-auto" unoptimized/>
              </div>
            </div>
            ...
            <div className="mt-12 text-center">
              ...
              <button onClick={handleStart} className="px-8 py-4 bg-gradient-to-r from-purple-500 to-purple-700 dark:from-cyan-400 dark:to-cyan-600
        ...
        <section className="py-16 md:py-20 bg-white dark:bg-slate-900">
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <div className="space-y-4">
              {faq.map((item, idx) => (<details key={idx} className="p-4 sm:p-5 bg-slate-50 dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 group cursor-pointer" open={idx === 0}>
        ...
        <section className="py-20 text-center bg-gradient-to-tr from-indigo-900 via-purple-950 to-slate-900 text-white">
          ...
          <button onClick={handleStart} className="px-10 py-4 bg-gradient-to-r from-purple-500 to-purple-700 dark:from-cyan-400 dark:to-cyan-600 text-white font-bold rounded-lg text-xl hover:scale-105 transition-all shadow-xl">
