...
const HomePage = () => {
    ...
    function HeroBanner() {
        return (<section className="relative py-20 md:py-32 text-center text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-20">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <button onClick={handleGoToGamingLogo} className="text-lg font-bold shadow-xl" id="cta-hero-gaming-logo">
              Design Text & Mascot Logos <FaChevronRight className="inline ml-2"/>
            </button>
            <button onClick={handleGoToPfpMaker} className="text-lg font-bold shadow-xl" id="cta-hero-pfp-maker">
    ...
    function LogoTypesSection() {
        ...
        return (<section className="py-16 md:py-20 px-4 sm:px-8 bg-white dark:bg-slate-900">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {logoTypes.map((type) => (<div key={type.name} className="flex flex-col items-center bg-slate-50 dark:bg-slate-800 p-6 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-transparent hover:border-purple-300 dark:hover:border-cyan-400">
                ...
                <Link href={type.href} id={type.id} className="mt-auto px-6 py-2 bg-purple-600 dark:bg-cyan-500 text-white dark:text-slate-900 font-semibold rounded-lg hover:opacity-90 transition-opacity">
                    {type.cta}
                </Link>
              </div>))}
          </div>
    ...
    function TwitchBannerSection() {
        return (<section className="py-16 md:py-20 px-4 sm:px-8 bg-slate-50 dark:bg-slate-950">
        <div className="container mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-12 text-slate-900 dark:text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto items-center">
            ...
            <div className="relative rounded-xl overflow-hidden shadow-2xl group aspect-video">
              <Image src="/twitch/banner/fortnite-prv.webp" // << replace with your S3 preview later
         alt="AI Twitch Banner Example" fill style={{ objectFit: "cover" }} className="transition-transform duration-500 group-hover:scale-105" unoptimized={true}/>
            </div>
            ...
            <div>
              ...
              <Link href="/banner-maker" className="inline-block px-8 py-3 bg-purple-600 dark:bg-cyan-500 text-white dark:text-slate-900 font-semibold rounded-lg hover:opacity-90 transition-opacity shadow-lg" id="cta-home-twitch-banner">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto items-center">
            ...
            <div>
              ...
              <Link href="/twitch-panels-generator" className="inline-block px-8 py-3 bg-purple-600 dark:bg-cyan-500 text-white dark:text-slate-900 font-semibold rounded-lg hover:opacity-90 transition-opacity shadow-lg" id="cta-home-twitch-panels">
            ...
            <div className="relative rounded-xl overflow-hidden shadow-2xl aspect-[16/5]">
              <Image src="/twitch/panels/valorant_strike_prv.webp" alt="AI Twitch Panels Examples" fill style={{ objectFit: "cover" }} unoptimized/>
            </div>
          </div>
        </div>
      </section>);
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto items-center">
            ...
            <div className="relative rounded-xl overflow-hidden shadow-2xl">
              <Image src="/twitch/emotes/emotes-boy.webp" alt="Custom Twitch emotes generated from a real face using AI" width={600} height={400} className="rounded-xl" unoptimized/>
            </div>
            ...
            <div>
              ...
              <Link href="/twitch-emote-maker" className="inline-block px-8 py-3 bg-purple-600 dark:bg-cyan-500 text-white dark:text-slate-900 font-semibold rounded-lg hover:opacity-90 transition-opacity shadow-lg" id="cta-home-twitch-emotes">
    ...
    function KeyFeaturesSection() {
        ...
        return (<section className="py-16 md:py-20 px-4 sm:px-8 bg-white dark:bg-slate-800">
        <div className="container mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-12 text-slate-900 dark:text-white">
            Why <span className="text-purple-600 dark:text-cyan-400">GamingLogoAI</span> Stands Out
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature) => (<div key={feature.title} className="flex flex-col items-center text-center p-6 bg-slate-50 dark:bg-slate-700 rounded-xl shadow-lg hover:shadow-purple-500/20 dark:hover:shadow-cyan-500/20 transition-shadow duration-300">
    ...
    function HowItWorksSection() {
        ...
        return (<section className="py-16 md:py-20 px-4 sm:px-8 bg-slate-100 dark:bg-slate-900">
        <div className="container mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-center mb-12 text-slate-900 dark:text-white">
                Launch Your Logo in <span className="text-purple-600 dark:text-cyan-400">4 Easy Steps</span>
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {steps.map(step => (<div key={step.number} className="relative p-6 bg-white dark:bg-slate-800 rounded-lg shadow-md">
                ...
                <button onClick={handleGoToGamingLogo} className="px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-slate-900 font-semibold rounded-lg text-md hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 ease-in-out transform hover:scale-105 shadow-lg hover:shadow-cyan-500/50" id="how-it-works-cta-gaming">
                    Start Designing Gaming Logo
                </button>
                <button onClick={handleGoToFaceLogo} className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-lg text-md hover:from-purple-600 hover:to-pink-600 transition-all duration-300 ease-in-out transform hover:scale-105 shadow-lg hover:shadow-purple-500/50" id="how-it-works-cta-face">
    ...
    function TestimonialSection() {
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (<div key={index} className="p-6 bg-slate-50 dark:bg-slate-700 rounded-xl shadow-lg flex flex-col">
    ...
    function FinalCTASection() {
        const handleGoToGamingLogo = () => { void router.push("/gaming-logo-maker"); };
        const handleGoToFaceLogo = () => { void router.push("/face-logo-generator"); };
        return (<section className="py-16 md:py-24 px-4 sm:px-8 bg-gradient-to-r from-purple-700 via-indigo-800 to-purple-900 text-white">
    ...
    function WhoIsThisForSection() {
        const targetAudiences = [
            {
                ...
                icon: s3Style("/styles/s432e.webp"),
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {targetAudiences.map((audience) => (<div key={audience.name} className="p-6 text-center bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700">
              <Image src={audience.icon} alt={audience.alt} width={64} height={64} className="mx-auto mb-4"/>
    ...
    function StyleShowcaseSection() {
        const showcaseItems = [
            {
                ...
                imageUrl: s3Style("/styles/s486e.webp"),
            ...
            },
            {
                ...
                imageUrl: "/images/showcase/fortnite-pfp-4.webp",
        ...
        return (<section className="py-16 md:py-20 px-4 sm:px-8 bg-white dark:bg-slate-900">
      <div className="container mx-auto">
        {showcaseItems.map((item, index) => (<div key={item.title} className={`flex flex-col md:flex-row items-center gap-8 lg:gap-16 ${index % 2 !== 0 ? 'md:flex-row-reverse' : ''} ${index > 0 ? 'mt-16' : ''}`}>
            {/* Image Column */}
            <div className="w-full md:w-1/2">
              <div className="relative aspect-square rounded-xl shadow-2xl overflow-hidden group">
                <Image src={item.imageUrl} alt={item.alt} fill style={{ objectFit: "cover" }} sizes="(max-width: 768px) 100vw, 50vw" className="transition-transform duration-500 group-hover:scale-105"/>
              </div>
            </div>
            {/* Text Column */}
            <div className="w-full md:w-1/2 text-center md:text-left">
              ...
              <Link href={item.ctaLink} className="inline-block px-8 py-3 bg-purple-600 dark:bg-cyan-500 text-white dark:text-slate-900 font-semibold rounded-lg hover:opacity-90 transition-opacity shadow-md">
                  {item.ctaText}
              </Link>
            </div>
          </div>))}
    ...
    return (<>
      <Head>
        ...
        <meta name="description" content="Create a stunning AI gaming logo or mascot with GamingLogoAI! Our generator is perfect for esports teams, streamers, and clans. Sign up to get 1 free credit to start designing now!"/>
