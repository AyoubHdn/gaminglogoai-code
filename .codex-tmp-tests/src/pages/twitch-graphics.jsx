...
import { FaTwitch, FaPalette, FaUserCircle, FaSmile, FaImages, FaLayerGroup, FaPlayCircle, FaChevronRight, FaCheckCircle, } from "react-icons/fa";
const TwitchGraphicsLandingPage = () => {
    const tools = [
        {
    ...
    return (<>
      <Head>
        ...
        <meta name="description" content="Create professional Twitch graphics with AI. Logos, emotes, banners, panels, PFPs & stream screens — everything your Twitch channel needs."/>
        <meta name="keywords" content="twitch graphics, twitch branding, twitch stream graphics, twitch emotes, twitch panels, twitch banner, twitch logo"/>
      ...
      <main className="bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-200 overflow-x-hidden">
        ...
        <section className="relative py-24 md:py-32 text-center text-white">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4">
            ...
            <Link href="#tools" className="inline-flex items-center gap-2 px-10 py-4 bg-gradient-to-r from-purple-500 to-purple-700
        ...
        <section id="tools" className="py-20 bg-slate-50 dark:bg-slate-950">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {tools.map((tool) => (<div key={tool.title} className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col">
                  <div className="relative aspect-video">
                    <Image src={tool.img} alt={tool.title} fill className="object-cover" unoptimized/>
                  </div>
                  ...
                  <div className="p-6 flex flex-col grow">
                    ...
                    <Link href={tool.href} className="mt-auto inline-flex items-center justify-center gap-2 px-6 py-3
        ...
        <section className="py-20 text-center bg-gradient-to-tr from-indigo-900 via-purple-950 to-slate-900 text-white">
          ...
          <Link href="/gaming-logo" className="inline-block px-10 py-4 bg-gradient-to-r from-purple-500 to-purple-700
