...
const RefundPolicyPage = () => {
    ...
    return (<>
      <Head>
        ...
        <meta name="description" content={`Understand our refund policy at ${siteName}. Learn about terms for credit purchases for AI-generated gaming logos.`}/>
          ...
          <article className="prose prose-lg lg:prose-xl dark:prose-invert mx-auto
            ...
            <p>
             ...
             <div className="mt-12 text-center not-prose"> {/* Added not-prose to prevent prose styling on button container */}
                <Link href="/buy-credits" legacyBehavior={false} className="inline-block px-6 py-3 font-semibold rounded-lg transition-all duration-300 ease-in-out
