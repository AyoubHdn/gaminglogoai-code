...
import PseoPfpPageTemplate from "~/component/pSEO/PseoPfpPageTemplate";
import { faceStylesData } from "~/data/faceStylesData";
import { createSlug } from "~/lib/utils";
import { getStaticRelatedItems, getShowcaseItems } from "~/lib/pSEO";
const PfpGamePage = ({ gameTitle, styleItem, slug, relatedItems, otherShowcaseItems }) => {
...
export const getStaticProps = async ({ params }) => {
    ...
    const matchedStyleItem = allGameStyles.find((item) => createSlug(item.name, '-pfp-maker') === slug);
    if (!matchedStyleItem) {
