...
const TermsOfServicePage = () => {
    ...
    return (<>
      <Head>
        ...
        <meta name="description" content={`Review the Terms of Service for using ${siteName}. Understand your rights and responsibilities when using our AI gaming logo generator.`}/>
