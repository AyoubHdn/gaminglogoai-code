...
import { FaCheckCircle, FaChevronRight, FaPaintBrush, FaSmile, FaImages, FaUserCircle, } from "react-icons/fa";
...
const BuyCreditsPage = () => {
    ...
    return (<>
      <Head>
        ...
        <meta name="description" content="Buy credits and design your Twitch logo, banner, profile picture, panels, stream screens, and emotes. One simple credit system. No subscriptions."/>
      ...
      <main className="min-h-screen bg-gray-100 dark:bg-slate-900 text-slate-800 dark:text-slate-200 px-4 py-16">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow">
              <ul className="space-y-4 text-sm">
                ...
                <li className="flex items-center justify-between">
                  <span className="flex items-center gap-2">
                    <FaImages /> Banner / Panel / Screen (1–3 credits)
                  </span>
                  <span className="text-slate-500">~$0.10–$0.30</span>
                </li>
        ...
        <section className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {offers.map((offer) => (<div key={offer.plan} className={`relative bg-white dark:bg-slate-800 rounded-xl p-6 shadow-xl border
                  ${offer.popular
                ? "border-purple-600 ring-2 ring-purple-500"
                : "border-slate-300 dark:border-slate-700"}`}>
                {offer.popular && (<span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-purple-600 text-white text-xs font-bold px-4 py-1 rounded-full">
                    Most Popular
                  </span>)}
                ...
                <button onClick={() => void handleBuy(offer.plan)} disabled={loadingPlan === offer.plan} className={`w-full py-3 font-semibold rounded-lg transition
                    ${offer.popular
                ...
                <div className="mt-6 text-xs text-slate-500">
                  ...
                  {offer.plan === "starter" && (<ul className="list-disc list-inside">
                      <li>Logo + Banner</li>
                      <li>OR 1 Profile Picture</li>
                      <li>OR a few emotes</li>
                    </ul>)}
                  {offer.plan === "pro" && (<ul className="list-disc list-inside">
                      <li>Logo</li>
                      <li>Banner + Panels</li>
                  ...
                  {offer.plan === "elite" && (<ul className="list-disc list-inside">
        ...
        <section className="max-w-4xl mx-auto text-center mt-24">
          ...
          <Link href="/twitch-graphics" className="inline-flex items-center gap-2 px-8 py-4 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-lg">
