...
const TwitchStreamScreensLanding = () => {
    return (<>
      <Head>
        <title>Twitch Stream Screens Maker | Starting Soon, BRB & Offline</title>
        <meta name="description" content="Create professional Twitch stream screens in seconds. Generate Starting Soon, BRB, Offline, and Intermission screens with AI. Perfect 1920x1080 resolution."/>
        <link rel="canonical" href="https://gaminglogoai.com/twitch-stream-screens-maker"/>
      ...
      <main className="overflow-x-hidden">
        ...
        <section className="relative py-20 md:py-28 text-center text-white">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <Link href="/twitch-stream-screens-generator" className="inline-block px-8 py-4 bg-purple-600 hover:bg-purple-700 rounded-lg text-white font-semibold text-lg shadow-xl transition" id="cta-hero-stream-screens">
        ...
        ].map((item) => (<div key={item.title} className="rounded-xl overflow-hidden shadow-lg bg-white dark:bg-slate-800">
                  <div className="relative aspect-video">
                    <Image src={item.img} alt={`${item.title} Twitch screen`} fill className="object-cover" unoptimized/>
                  </div>
        ...
        ].map((f) => (<div key={f.title} className="p-6 rounded-xl bg-slate-50 dark:bg-slate-800 shadow">
        ...
        ].map((s) => (<div key={s.step} className="relative p-6 bg-white dark:bg-slate-800 rounded-xl shadow">
        ...
        <section className="py-20 bg-gradient-to-r from-purple-700 via-indigo-800 to-purple-900 text-white text-center">
          <div className="container mx-auto px-4">
            ...
            <Link href="/twitch-stream-screens-generator" className="inline-block px-10 py-4 bg-cyan-500 hover:bg-cyan-600 text-slate-900 font-semibold rounded-lg shadow-lg transition">
