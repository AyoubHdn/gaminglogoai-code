...
const PseoLogoPageTemplate = ({ pageTitle, metaDescription, keywords, canonicalUrl, h1, heroImageSrc, introParagraph, ctaText, handleCtaClick, showcaseTitle, imageShowcaseGrid, relatedItems, faqItems, faqTitle, finalCtaTitle }) => {
        ...
        <section className="py-16 md:py-20 bg-white dark:bg-slate-900">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {imageShowcaseGrid.map((image, index) => (<div key={index} className="group relative rounded-lg shadow-lg overflow-hidden aspect-square">
        ...
        <section className="py-16 md:py-20 bg-white dark:bg-slate-900">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {commonFeatures.map((feature) => (<div key={feature.title} className="flex p-6 bg-slate-50 dark:bg-slate-800/60 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 border border-slate-200 dark:border-slate-700/50">
        ...
        <section className="py-16 md:py-20 bg-slate-50 dark:bg-slate-950">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {relatedItems.map((item) => (<Link key={item.slug} href={`/${item.tool}/${item.categoryPath}/${item.slug}`} className="block p-4 bg-white dark:bg-slate-800 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 flex items-center group">
