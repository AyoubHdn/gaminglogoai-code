...
export const twitchBannerRouter = createTRPCRouter({
    generate: protectedProcedure
        ...
        // 2. Deduct credits
        const creditsNeeded = (_a = style.creditCost) !== null && _a !== void 0 ? _a : 2;
        ...
        if (style.backgroundSrc.startsWith("http")) {
            ...
            if (!resp.ok)
                throw new Error("Cannot load background from S3");
        ...
        let finalCanvasBuffer = backgroundBuffer;
        if (style.supportsPhoto && logoUrl && style.styleRules.photo) {
            try {
                ...
                if (!resp.ok)
                    throw new Error("Cannot fetch user photo");
        ...
        const channelFont = (_b = fonts[channelRule.fontFamily]) !== null && _b !== void 0 ? _b : { family: "sans-serif" };
        ...
        <svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
          ...
          <text
            ...
            letter-spacing="${(_c = channelRule.letterSpacing) !== null && _c !== void 0 ? _c : 0}"
            text-anchor="${(_d = channelRule.textAnchor) !== null && _d !== void 0 ? _d : "start"}"
            font-weight="${(_e = channelRule.fontWeight) !== null && _e !== void 0 ? _e : "bold"}"
          >
          ...
          ${hasTagline
            ? `<text
                   x="${taglineRule.x}"
                   y="${taglineRule.y}"
                   font-family="${escapeXml((_f = taglineFont === null || taglineFont === void 0 ? void 0 : taglineFont.family) !== null && _f !== void 0 ? _f : "sans-serif")}"
                   font-size="${taglineRule.fontSize}"
                   fill="${taglineRule.color}"
                   letter-spacing="${(_g = taglineRule.letterSpacing) !== null && _g !== void 0 ? _g : 0}"
                   text-anchor="${(_h = taglineRule.textAnchor) !== null && _h !== void 0 ? _h : "start"}"
                   font-weight="${(_j = taglineRule.fontWeight) !== null && _j !== void 0 ? _j : "normal"}"
                 >
