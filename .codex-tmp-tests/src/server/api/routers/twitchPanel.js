...
export const twitchPanelRouter = createTRPCRouter({
    generate: protectedProcedure
        ...
        /* 2. Credits */
        const creditsNeeded = (_a = style.creditCost) !== null && _a !== void 0 ? _a : 1;
        ...
        if (style.backgroundSrc.startsWith("http")) {
            ...
            if (!resp.ok)
                throw new Error("Cannot load background");
        ...
        const titleFont = (_b = fonts[titleRule.fontFamily]) !== null && _b !== void 0 ? _b : { family: "sans-serif" };
        /* 5. SVG */
        const svg = `
        <svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
          ...
          <text
            ...
            text-anchor="${(_c = titleRule.textAnchor) !== null && _c !== void 0 ? _c : "start"}"
            font-weight="${(_d = titleRule.fontWeight) !== null && _d !== void 0 ? _d : "bold"}"
            letter-spacing="${(_e = titleRule.letterSpacing) !== null && _e !== void 0 ? _e : 0}"
          >
