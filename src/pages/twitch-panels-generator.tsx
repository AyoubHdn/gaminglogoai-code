...
import { Step3Result } from "~/component/panelFunnel/Step3Result";

const PAGE_TITLE = "AI Twitch Panels Generator | GamingLogoAI";
const PAGE_DESCRIPTION =
  "Create AI-generated Twitch panel sets with a guided flow. Pick a platform, choose a game-based template, build multiple panels, and generate them together.";
const PAGE_URL = "https://gaminglogoai.com/twitch-panels-generator";

function TwitchPanelsGeneratorContent() {
  ...
  const steps = [
    {
      ...
      key: "step0",
      title: "Platform",
      description: "Choose where the panel will live",
    },
    {
      step: 2,
      key: "step1",
      title: "Template",
      description: "Pick a panel art direction",
    },
    {
      step: 3,
      key: "step2",
      title: "Personalize",
      description: "Add text, logo, socials, and shape",
    },
    {
      step: 4,
      key: "step3",
    ...
    <main className="container mx-auto max-w-screen-xl px-4 py-8 sm:px-8">
      <header className="mb-8 text-center">
        ...
        <p className="mx-auto mt-3 max-w-3xl text-lg text-slate-600 dark:text-slate-400">
          Create branded Twitch panel sets in one guided flow, from game-based
      ...
      {!hasHydrated ? (
        <section className="rounded-2xl border border-slate-200 bg-white p-10 text-center shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <p className="mt-4 text-sm text-slate-500 dark:text-slate-400">
            Restoring your panel funnel session...
          </p>
        </section>
      ) : currentStep === "step0" ? (
