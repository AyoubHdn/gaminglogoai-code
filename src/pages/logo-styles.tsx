  ...
  for (const config of logoCategoriesConfig) {
    ...
    if (dataSet) {
      ...
      styleCategories.push({
        ...config,
        subItemsPreview,
        relevantTools: [{ name: "Open Gaming Logo Maker", url: "/studio?tool=logo", iconName: "pen", variant: "primary" }], // Added iconName
      });
    }
  }
  ...
  for (const config of pfpCategoriesConfig) {
    ...
    if (dataSet) {
      ...
      styleCategories.push({
        ...config,
        subItemsPreview,
        relevantTools: [{ name: "Open AI PFP Maker", url: "/studio?tool=pfp", iconName: "user", variant: "accent" }], // Added iconName
      });
    }
  }
