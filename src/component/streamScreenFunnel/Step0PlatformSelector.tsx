    ...
    <section className="space-y-6">
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
          We&apos;re starting with platforms that use full-screen stream scenes in a
          meaningful creator workflow.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:max-w-xl">
        ...
        >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">
                  Starting Soon, BRB, Offline, and Ending scenes
                </p>
              </div>
            </div>
          ...
          <p className="mt-3 text-xs uppercase tracking-wide text-slate-400 dark:text-slate-500">
            Fixed canvas: {platform.canvas.width}x{platform.canvas.height}
          </p>
        </button>
      </div>
    </section>
