...
export type ReferenceSource = "upload" | "designs" | "none" | null;
...
const STORAGE_KEY = "thumbnail-maker-state";
...
export function FunnelProvider({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.error("Failed to restore thumbnail funnel state:", error);
    } finally {
      setHasHydrated(true);
    }
  }, []);
