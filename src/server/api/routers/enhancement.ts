...
async function enhanceImageWithAI(
  ...
  function isNodeReadableStream(obj: unknown): obj is Readable {
    return obj instanceof Readable;
  }
  // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
  
  function isWebReadableStream(obj: unknown): obj is WebReadableStream<Uint8Array> {
    return (
      typeof obj === "object" &&
      obj !== null &&
      typeof (obj as any).getReader === "function"
    );
  }
