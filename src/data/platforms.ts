export type PlatformId = "twitch" | "youtube" | "kick" | "discord" | "tiktok";
export type SurfaceId = "banner" | "panel" | "stream-screen" | "emote";
export type AllowedSurfaceFormat = "png" | "jpg" | "webp";
...
export interface PlatformSurfaceConfig {
  ...
  allowedFormats: AllowedSurfaceFormat[];
}
...
export interface PlatformConfig {
  ...
  displayName: string;
  enabled: boolean;
  surfaces: Partial<Record<SurfaceId, PlatformSurfaceConfig>>;
}
